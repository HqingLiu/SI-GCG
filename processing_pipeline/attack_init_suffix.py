            ...
            with torch.no_grad():
                ...
                if is_success_llama and activate:
                    ...
                    if jailbroken1 and jailbroken2[0] == 1:
                        ...
                        suffix_lists.append(final_adv_suffix)
                ...
                gc.collect()
                torch.cuda.empty_cache()
    return result_json_data, suffix_lists
...
if __name__ == "__main__":
    ...
    output_data, suffix_lists = process_attack(
        model_llama_path,
        model_roberta_path,
        indexs,
        batch_size,
    ...
    with open("./data/suffix_lists.json", "w") as output_file:
        json.dump(suffix_lists, output_file, indent=4)
